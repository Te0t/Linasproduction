...
<html <?php language_attributes(); ?>>
  <head>
    ...
    - primary meta tags
  -->
    <title>Lina's - Comida deliciosa para tus eventos</title>
    <meta name="title" content="Lina's - Comida deliciosa para tus eventos" />
    <meta
      name="description"
      content="template made by Harley Taberner"
    />
  ...
  -->
    ...
    <div class="preload" data-preaload>
      ...
      <p class="text">Lina's Production</p>
    </div>
    ...
    <div class="topbar">
      <div class="container">
        <address class="topbar-item">
          ...
          <span class="span">
            Carr 411 km 8 BO, 00602, Aguada, Puerto Rico.
          </span>
        </address>
        ...
        <div class="topbar-item item-2">
          ...
          <span class="span">Daily : 7:30 am a 3:00 pm</span>
        </div>
        ...
        <a href="tel:+11234567890" class="topbar-item link">
          ...
          <span class="span">+1 787 951 6448</span>
        </a>
        ...
        <a href="mailto:booking@restaurant.com" class="topbar-item link">
          ...
          <span class="span">Linas.production22@gmail.com</span>
        </a>
      </div>
    </div>
  ...
  -->
    ...
    <header class="header" data-header>
      <div class="container">
        <a href="#" class="logo">
          <img
            src="./assets/images/LogoLinasProduction.png"
            width="180"
            height="50"
            alt="Grilli - Home"
          />
        ...
        <div class="footer-top grid-list">
          <div class="footer-brand has-before has-after">
            ...
            <a href="tel:+88123123456" class="body-4 contact-link"
              >Booking Request : +88-123-123456</a
            >
